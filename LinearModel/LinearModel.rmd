...
$H_0$:  There is no difference in the models.  We fail to reject the null hypothesis showing that there is no difference between arm strength vs. arm+grip strength

$H_A$:  There is no difference in the models.  We reject the null hypothesis showing that there is a difference between arm strength vs arm+grip strength
